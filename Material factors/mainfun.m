%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This function is a Matlab implementation of the model. It authomatically
% simulates the model 100 runs and shows the results on an individual
% choice x, attitude y, and benefit of using a new technology b.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [Q] = mainfun(b0,bmin,bmax,avw,ave,s,f0,f1,f2,f3,nu,sw,se,mb,sb,mu,a0,sa1)
